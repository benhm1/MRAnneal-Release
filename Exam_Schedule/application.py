...
def generateSolution( args ) :
    ...
    """
    return exam.generate_clumping( args )
...
def anneal(args, solution) :
    ...
    return exam.anneal( args, solution )
...
def scoreSolution( args, solution ) :
    ...
    """
    return exam.goodness( args, solution )
...
def undoAnneal( args, solution, res ) :
    ...
    Returns: Nothing.
    """
    return exam.undoAnneal( args, solution, res )
